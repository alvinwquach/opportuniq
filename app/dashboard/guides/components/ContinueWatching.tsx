        ...
        {guides.map((guide) => {
          ...
          return (
            <div
              ...
              className="bg-gradient-to-br from-blue-500/10 to-[#1a1a1a] rounded-xl border border-blue-500/30 p-4 hover:border-blue-500/50 hover:shadow-lg transition-all cursor-pointer group"
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5 mb-1">
                    <span className="px-1.5 py-0.5 text-[9px] font-medium rounded bg-[#333] text-gray-500">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="flex items-center gap-1 text-xs text-blue-600 font-semibold hover:text-blue-500 transition-colors group/btn">
                      Continue
