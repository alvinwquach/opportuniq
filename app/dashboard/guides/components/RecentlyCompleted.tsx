...
export function RecentlyCompleted({ guides, onClick }: RecentlyCompletedProps) {
        ...
        {guides.slice(0, 3).map((guide) => {
          ...
          return (
            <div
              ...
              className="bg-gray-100 rounded-xl border border-blue-500/20 p-3 hover:border-blue-500/40 transition-all cursor-pointer group"
            >
