    ...
    <>
      ...
      <div className="bg-gray-100 rounded-lg border border-gray-200 p-3 sm:p-4">
        ...
        {pendingDecisions.length === 0 ? (
          <div className="py-6 text-center">
            <IoCheckmarkCircle className="w-8 h-8 mx-auto mb-2 text-blue-600/50" />
            ...
            {pendingDecisions.slice(0, 5).map((decision) => (
              ...
              >
                ...
                <div className="flex items-center gap-1.5 sm:gap-2 text-[9px] sm:text-[10px] mt-2 flex-wrap">
                  ...
                  {decision.proOption && (
                    <span className="px-1.5 sm:px-2 py-0.5 bg-gray-200 text-gray-500 rounded">
      ...
      {openIssues.length === 0 && pendingDecisions.length === 0 && (
        <div className="bg-gray-100 rounded-lg border border-gray-200 p-6 text-center">
          <IoCheckmarkCircle className="w-12 h-12 mx-auto mb-3 text-blue-600/50" />
