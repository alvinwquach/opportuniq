                  ...
                  <button
                    ...
                    className={`p-4 rounded-lg border text-left transition-all ${
                      isSelected
                        ...
                        : "bg-gray-50 border-gray-200 text-gray-500 hover:border-[#3a3a3a] hover:text-gray-900"
            ...
            {(field) => (
              <div className="relative max-w-xs">
                ...
                <input
                  ...
                  className="w-full h-11 pl-7 pr-3 rounded-lg bg-gray-50 border border-gray-200 text-gray-900 text-sm placeholder:text-[#444] focus:outline-none focus:border-[#5eead4]/50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                />
              </div>
            )}
          </form.Field>
        ...
        <div className="space-y-4">
          ...
          <form.Field name="trustOwnerAdmin">
            {(field) => (
              <div className="flex items-center justify-between p-3 rounded-lg bg-gray-50 border border-gray-200">
                <div>
                  <Label htmlFor="trustOwnerAdmin" className="text-sm text-gray-900 cursor-pointer">
          ...
          <form.Field name="allowModeratorApprove">
            {(field) => (
              <div className="flex items-center justify-between p-3 rounded-lg bg-gray-50 border border-gray-200">
                <div>
                  <Label htmlFor="allowModeratorApprove" className="text-sm text-gray-900 cursor-pointer">
