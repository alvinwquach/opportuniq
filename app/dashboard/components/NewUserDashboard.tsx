...
export function NewUserDashboard({ userProfile }: NewUserDashboardProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="p-6 rounded-2xl bg-linear-to-br from-[#00D4FF]/5 via-[#161616] to-[#00B4D8]/5 border border-gray-200">
        <div className="flex flex-col lg:flex-row lg:items-center gap-6">
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-3">
              <IoFlash className="h-4 w-4 text-blue-600" />
              <span className="text-[10px] font-medium text-blue-600 normal-case tracking-wider">
                Get Started
              </span>
            </div>
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-600/90 transition-colors"
            >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-lg bg-blue-50 flex items-center justify-center">
                <IoNavigate className="w-4 h-4 text-blue-600" />
              </div>
              <div>
        ...
        <div className="h-64 md:h-80">
          {hasLocation ? (
            ...
            <div className="h-full flex flex-col items-center justify-center bg-gray-50 text-center p-6">
              ...
              <p className="text-sm text-gray-500 mb-1">No location set</p>
              <p className="text-xs text-gray-400 max-w-62.5 mb-4">
              ...
              <Link
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-md bg-gray-100 text-gray-500 hover:text-gray-900 hover:bg-gray-200 transition-colors"
              >
      ...
      <section>
        <h2 className="text-sm font-medium text-gray-900 mb-4">How OpportunIQ Works</h2>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
          {[
            ...
            { step: 2, title: "Analyzes", description: "Get instant diagnosis and options", icon: IoFlash, bgClass: "bg-blue-50", textClass: "text-blue-600" },
            ...
            <div key={item.step} className="p-4 rounded-xl bg-gray-50 border border-gray-200">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-[10px] font-medium text-gray-400">Step {item.step}</span>
              </div>
              ...
              {item.additionalIcons && (
                <div className="flex items-center gap-2 mt-2 pt-2 border-t border-gray-200">
                  ...
                  {item.additionalIcons.map((Icon, i) => (
                    <Icon key={i} className="w-3 h-3 text-gray-400" />
                  ))}
                </div>
              )}
            </div>
