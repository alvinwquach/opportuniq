...
export function SavingsStatsSection({ savings }: SavingsStatsSectionProps) {
  ...
  return (
    <div className="p-4 rounded-xl bg-gradient-to-br from-[#00D4FF]/5 to-transparent border border-[#1f1f1f]">
      <div className="flex items-center gap-3 mb-3">
        <div className="w-10 h-10 rounded-xl bg-[#00D4FF]/10 flex items-center justify-center">
          <IoWallet className="w-5 h-5 text-[#00D4FF]" />
        </div>
        <div>
          <p className="text-[10px] uppercase tracking-wider text-[#9a9a9a]">Total Saved</p>
