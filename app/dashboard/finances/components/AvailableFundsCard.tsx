      ...
      <div className="flex items-start justify-between">
        <div>
          <div className="flex items-center gap-2 mb-2">
            <IoWallet className={`w-5 h-5 ${isLow ? "text-amber-400" : "text-emerald-400"}`} />
            <h3 className="text-sm font-medium text-[#888]">Available for Repairs & Upgrades</h3>
          </div>
          <div className="flex items-baseline gap-2">
            <span className={`text-3xl font-bold ${isLow ? "text-amber-400" : "text-emerald-400"}`}>
        ...
        <div className="text-right space-y-1">
          <div className="flex items-center justify-end gap-1.5 text-xs text-[#666]">
            <IoTrendingUp className="w-3.5 h-3.5 text-emerald-400" />
