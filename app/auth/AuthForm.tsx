...
// Inline styles for AAA accessibility - light mode only
const styles = {
  text: { color: '#111827' },
...
export function AuthForm({ inviteToken, groupName }: AuthFormProps) {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-[55%_45%]" style={{ backgroundColor: '#f3f4f6' }}>
      {/* LEFT SIDE - Benefits (Light mode) */}
      <div className="hidden lg:flex flex-col justify-between p-12" style={{ backgroundColor: '#eff6ff' }}>
        <div>
          <Link href="/" className="flex items-center gap-3">
            {/* Logo - blue version */}
            <svg viewBox="0 0 100 100" className="w-10 h-10" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M50 5 L85 25 L85 65 L50 85 L15 65 L15 25 Z" stroke="#1d4ed8" strokeWidth="3" fill="none" />
              <path d="M50 15 L75 30 L75 60 L50 75 L25 60 L25 30 Z" stroke="#1d4ed8" strokeWidth="2.5" fill="#2563eb" fillOpacity="0.15" />
              <circle cx="50" cy="45" r="15" stroke="#1d4ed8" strokeWidth="4" fill="none" strokeDasharray="70 30" transform="rotate(-90 50 45)" />
              <path d="M 60 55 L 70 65" stroke="#1d4ed8" strokeWidth="4" strokeLinecap="round" />
              <circle cx="50" cy="45" r="5" fill="#1d4ed8" />
        ...
        <div className="space-y-10">
          <div>
            <h1 className="text-4xl font-bold mb-4 leading-tight" style={styles.text}>
              Make smarter{" "}
              <span style={{ color: '#2563eb' }}>decisions</span>
            </h1>
              ...
              <div key={index} className="flex items-start gap-4">
                <div className="shrink-0">
                  <div
                    ...
                    style={{ backgroundColor: '#dbeafe', border: '2px solid #bfdbfe' }}
                  >
                    <IoCheckmarkCircle className="h-6 w-6" style={{ color: '#2563eb' }} />
                  </div>
                </div>
                <div>
      ...
      {/* RIGHT SIDE - Form */}
      <div className="flex flex-col min-h-screen p-6 lg:p-12" style={{ backgroundColor: '#ffffff' }}>
        {/* Mobile Header */}
        <header className="lg:hidden mb-8 -mx-6 -mt-6 px-6 py-4 border-b" style={{ borderColor: '#e5e7eb' }}>
                ...
                {loading === "github" ? (
                  <>
                    <span
                      ...
                      style={{ border: '2px solid #d1d5db', borderTopColor: '#2563eb' }}
                      aria-hidden="true"
                    />
                    Signing in...
                  </>
