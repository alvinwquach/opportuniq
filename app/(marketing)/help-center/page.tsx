...
const SUPPORT_OPTIONS = [
  ...
  {
    title: "Documentation",
    description: "Browse our comprehensive documentation to learn how to get the most out of OpportunIQ. Guides, tutorials, and API references.",
    icon: (
  ...
  {
    title: "API Reference",
    description: "Integrate OpportunIQ into your applications with our REST API. Full documentation for enterprise developers.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const FAQ_ITEMS = [
  ...
  {
    question: "Can I use OpportunIQ for my business?",
    answer: "Absolutely. We offer enterprise plans for property managers, landlords, and real estate investors. Contact us for custom pricing and features.",
  },
  {
    question: "How do I get help?",
    answer: "Join our Discord community for real-time support from our team and other users. You can also browse our documentation for guides and tutorials.",
  },
];
      ...
      <section className="py-16 px-6 bg-linear-to-b from-white to-neutral-50">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-neutral-600 mb-8">
            Browse our comprehensive help center for guides, tutorials,
            and answers to common questions.
          </p>
          <Link href="/help-center">
            <Button
              className="h-12 px-8 font-mono font-bold text-white rounded-lg transition-all bg-teal-600 hover:bg-teal-700"
            >
