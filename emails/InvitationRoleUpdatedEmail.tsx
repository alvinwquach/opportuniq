...
interface InvitationRoleUpdatedEmailProps {
  groupName: string;
  changedBy: string;
  oldRole: string;
  newRole: string;
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={contentCard}>
            <Heading style={heroTitle}>Invitation Role Updated</Heading>
            <Text style={heroSubtitle}>
              Your pending invitation to join <strong>{groupName}</strong> has been updated with a new role.
            </Text>
...
export default InvitationRoleUpdatedEmail;
