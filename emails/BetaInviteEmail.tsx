...
export const BetaInviteEmail = ({
  inviteUrl = 'https://opportuniq.app/join?token=beta123',
  referrerName = 'An alpha member',
  expiresIn = '7 days',
}: BetaInviteEmailProps) => {
  return (
    <Html>
      <Head />
      <Preview>Kevin and Alvin invite you to join OpportunIQ Beta</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={contentCard}>
            <Section style={badgeSection}>
              <Text style={badge}>BETA ACCESS</Text>
            </Section>
            ...
            <Section style={benefitsSection}>
              ...
              <div style={benefitItem}>
                <Text style={benefitIcon}>•</Text>
                <Text style={benefitText}>Ability to invite others you think would benefit</Text>
              </div>
            </Section>
