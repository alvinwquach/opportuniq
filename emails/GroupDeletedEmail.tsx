...
export const GroupDeletedEmail = ({
  memberName = 'there',
  groupName = 'My Group',
  deletedBy = 'Someone',
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={contentCard}>
            <Heading style={heroTitle}>Group Deleted</Heading>
            <Text style={heroSubtitle}>
              Hi {memberName}, we wanted to let you know that a group you were part of has been removed.
            </Text>
            <Section style={groupBox}>
              <Text style={groupLabel}>DELETED GROUP</Text>
              <Text style={groupNameText}>{groupName}</Text>
              <Text style={deletedByText}>Deleted by {deletedBy}</Text>
            </Section>
            ...
            <Text style={securityNote}>
              If you believe this was done in error, please contact the person who deleted the group.
            </Text>
          </Section>
