            ...
            {[
              {
                icon: Wrench,
                title: "DIY it",
                desc: "Parts are cheap, job is straightforward, and you've got the time and tools",
                color: "primary",
              },
              {
                icon: HardHat,
                title: "Call a pro",
                desc: "Your time is worth more than the labor cost, or you might make it worse",
                color: "blue",
              },
              {
                icon: Timer,
                title: "Wait it out",
                desc: "Prices are dropping, it's not urgent, or you need to save up first",
                color: "yellow",
              },
            ].map((option, i) => (
              <div
