        ...
        <div className="bg-neutral-900 rounded-[1.25rem] aspect-[9/14] flex flex-col overflow-hidden">
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-3 relative">
            ...
            <div className="flex gap-4 items-center">
              ...
              <button className="w-14 h-14 rounded-full bg-white flex items-center justify-center shadow-lg border-4 border-neutral-300">
      ...
      <div className="bg-white rounded-xl border border-neutral-200 shadow-sm p-4">
        <div className="bg-neutral-50 rounded-lg p-3 mb-3">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs text-neutral-400 ml-auto">0:04</span>
          </div>
        ...
        <div className="px-5 pt-5 pb-4">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <div className="text-sm text-neutral-500">Hairline crack — cosmetic only</div>
            </div>
          </div>
  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 max-w-5xl">
        <div className="problem-header text-center mb-14 lg:mb-16">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold mb-4 leading-tight text-neutral-900 tracking-tight">
            ...
            <br />
            <span className="text-teal-600">We Make Them Simple.</span>
          </h2>
          <p className="text-base sm:text-lg max-w-xl mx-auto leading-relaxed text-neutral-500">
        ...
        <div className="steps-container space-y-0">
          {STEPS.map((step, index) => (
            <div key={step.number}>
              ...
              <div className="step-item grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                <div className="order-2 md:order-1">
                  ...
                  <p className="text-sm sm:text-base font-medium text-teal-600 mb-3">
                    {step.subtitle}
                  </p>
                  <p className="text-neutral-500 leading-relaxed text-base sm:text-[17px]" style={{ lineHeight: 1.65 }}>
                    {step.description}
                  </p>
                </div>
