...
export const issues: Issue[] = [
  {
    ...
    category: 'HVAC',
    priority: 'high',
    assignee: { id: '1', name: 'Mike R.', role: 'Admin', avatar: 'M' },
    group: 'Main House',
  ...
  },
  {
    ...
    category: 'Plumbing',
    priority: 'medium',
    assignee: { id: '2', name: 'Sarah R.', role: 'Member', avatar: 'S' },
    group: 'Main House',
...
export const recentActivity: Activity[] = [
  { id: '1', message: 'Mike completed "Replace furnace filter"', time: '2h ago', avatar: 'M' },
  { id: '2', message: 'Sarah added a new issue: "Storm door closer"', time: '1d ago', avatar: 'S' },
  { id: '3', message: 'Parts ordered for sump pump repair', time: '2d ago', avatar: 'P' },
  { id: '4', message: 'Furnace inspection scheduled for Monday', time: '3d ago', avatar: 'C' },
];
