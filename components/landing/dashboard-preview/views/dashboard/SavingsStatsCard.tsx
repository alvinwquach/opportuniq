    ...
    <div className="p-3 sm:p-4 rounded-xl bg-[#161616] border border-[#1f1f1f]">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[9px] sm:text-[10px] font-medium text-emerald-400 uppercase tracking-wide">Total Saved</span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-1.5 text-[10px] sm:text-xs text-[#9a9a9a]">
        <IoCheckmarkCircle className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-emerald-400" />
