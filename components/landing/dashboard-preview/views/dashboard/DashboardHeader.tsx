    ...
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4 mb-4">
      <div>
        ...
        <p className="text-xs sm:text-sm text-gray-500">
          <span className="text-blue-600 font-medium">${hourlyRate}/hr</span>
          <span className="mx-1.5 sm:mx-2 text-gray-300">·</span>
          ${monthlyIncome.toLocaleString()}/mo income
        </p>
      </div>
      <span className="px-2.5 sm:px-3 py-1 sm:py-1.5 bg-blue-50 text-blue-600 text-[10px] sm:text-xs font-medium rounded-full flex items-center gap-1 sm:gap-1.5 border border-blue-200 w-fit">
